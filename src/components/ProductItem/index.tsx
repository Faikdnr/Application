  ...
  return (
    ...
    >
      ...
      <View style={{ flexDirection: "row", marginTop: 10, alignItems: 'center' }}>
        <Text style={{ textDecorationLine: "line-through", color: "#747990", fontWeight: "bold", fontSize: 10 }}>
      ...
      <TouchableOpacity onPress={() => addItemToCart(item)} style={{
        ...
        shadowRadius: 3.8, shadowOpacity: 0.05, borderColor: 'lightgrey', backgroundColor: 'white',
